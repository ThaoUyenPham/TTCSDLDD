...
<div class="main-content">
    ...
    <!---------------------------------------------------------------------------------------------------->
            <div class="row"> <!-- bảng data -->
                <div class="col-md-12">        
                    <table id="loadUsers" class="display table table-bordered" style="width:100%"> 
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">Tên cơ quan/ tổ chức</th> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="list-ctkt text-right">
                        <a href="{{route('create.users')}}" class="btn btn-info btn-sm" id="">
...
<script>
   ...
   $(document).ready(function() {
    ...
    let columns = [ //gán giá trị cho từng cột
        ...
        {  
            ...
            render: function (data, type, row) {
                ...
                let editUrl = '{{ route("edit.users", ":id") }}';
    ...
    function loadUsers() {
        if ($.fn.dataTable.isDataTable('#loadUsers')) {

            text = "Danh sach Diem";
            table.destroy();
            table = $('#loadUsers').DataTable({
                columns: columns,
                columnDefs: [   
                    {
