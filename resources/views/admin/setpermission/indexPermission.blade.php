...
<div class="main-content">
    ...
    <!---------------------------------------------------------------------------------------------------->
            <div class="row"> <!-- bảng data -->
                <div class="col-md-12">        
                    <table id="loadListPermission" class="display table table-bordered" style="width:100%"> 
                        <thead>
                            <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="list-ctkt text-right">
                        <a href="{{route('create.permission')}}" class="btn btn-info btn-sm" id="">
...
<script>
   ...
   $(document).ready(function() {
    ...
    let columns = [ //gán giá trị cho từng cột
        ...
        {  
            ...
            render: function (data, type, row) {
                ...
                let editUrl = '{{ route("edit.permission", ":id") }}';
    ...
    var table=$('#loadListPermission').DataTable({});
    let text; 
    LoadListSecurity();
    function LoadListSecurity() {
        if ($.fn.dataTable.isDataTable('#loadListPermission')) {

            text = "Danh sach hệ thống";
            table.destroy();
            table = $('#loadListPermission').DataTable({
                columns: columns,
                columnDefs: [   
                    {
                ...
                ajax: {
                    url:"{{route('loadAdmin.permission')}}",
                    type: 'POST',
                    headers: {
