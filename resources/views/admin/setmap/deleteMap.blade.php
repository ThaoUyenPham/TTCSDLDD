    ...
    <div class="card">
        <div class="card-block pdd-vertical-15 pdd-horizon-15">
            <h4 class="card-title text-bold text-info">
                Chi tiết bản đồ chuyên đề đã xóa
            </h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="list-ctkt text-right">
                            ...
                            <a href="#" class="btn btn-info btn-sm" id="delete_map">
                                <i class="ti-plus pdd-right-5"></i>
                                <span>Khôi phục</span>
                            </a>
                            <a href="{{route('index.delete.super')}}" class="btn btn- btn-sm btn-primary">
                                <i class="ti-plus pdd-right-5"></i>
                                <span>Quay Lại</span>
                            </a>
                        </div>
      ...
      // Add input
        ...
        $('#delete_map').click(function(){ 
            if(confirm("Bạn có chắc muốn xóa bản đồ này"))
            {
                ...
                let editUrl = '{{ route("restore.subjectmap.delete",":id") }}';
