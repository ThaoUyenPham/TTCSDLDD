...
<div class="main-content">
    ...
    <!---------------------------------------------------------------------------------------------------->
            <div class="row"> <!-- bảng data -->
                <div class="col-md-12">        
                    <table id="load_list_systemgeo" class="display table table-bordered" style="width:100%"> 
                        <thead>
                            <tr>
...
<script>
   ...
   $(document).ready(function() {
    ...
    let columns = [ //gán giá trị cho từng cột
        ...
        {  
            ...
            render: function (data, type, row) {
                ...
                let editUrl = '{{ route("edit.systemgeo", ":id") }}';
    ...
    var table=$('#load_list_systemgeo').DataTable({  
    });
    let text;
    $("#search_data").click(()=>{
    ...
    LoadServerGeo();
    function LoadServerGeo() {
        let find_name=$('#find_name').val();
        if ($.fn.dataTable.isDataTable('#load_list_systemgeo')) {

            text = "Danh sach hệ thống";
            table.destroy();
            table = $('#load_list_systemgeo').DataTable({
                columns: columns,
                columnDefs: [   
                    {
                ...
                ajax: {
                    url:"{{route('load_index.systemgeo')}}",
                    type: 'POST',
                    headers: {
