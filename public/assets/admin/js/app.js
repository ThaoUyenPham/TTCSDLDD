...
/* Phần quyền User */
var user_name = $(".user-info span").html()
if (user_name.includes("user")) {
    $("#dm_soft").hide();
    $("#homepage").hide();

    $("#create_giengqt_ndd").hide();
    $("#delete_create_giengqt_ndd").hide();
    ...
    $("i[data-target=\"#info-ctkt\"]").hide();

    $("#create_poi_ktsd_ndd").hide();
    $("#delete_poi_ktsd_ndd").hide();
    $("#save_poi_ktsd_ndd").hide();
    $("#create_gp_ndd").hide();
    $("#delete_gp_ndd").hide();
    $("#save_gp_ndd").hide();
    $("#create_tiencq_ndd").hide();
    $("#delete_tiencq_ndd").hide();
    $("#save_tiencq_ndd").hide()
    $("#create_thvp_ndd").hide();
    $("#delete_thvp_ndd").hide();
    $("#save_thvp_ndd").hide()

    $("#create_poi_ktsd_nm").hide();
    $("#delete_poi_ktsd_nm").hide();
    $("#save_poi_ktsd_nm").hide();
    $("#create_gp_nm").hide();
    $("#delete_gp_nm").hide();
    $("#save_gp_nm").hide();
    $("#create_tiencq_nm").hide();
    $("#delete_tiencq_nm").hide();
    $("#save_tiencq_nm").hide()
    $("#create_thvp_nm").hide();
    $("#delete_thvp_nm").hide();
    $("#save_thvp_nm").hide()

    $("#create_poi_ktsd_td").hide();
    $("#delete_poi_ktsd_td").hide();
    $("#save_poi_ktsd_td").hide();
    $("#create_gp_td").hide();
    $("#delete_gp_td").hide();
    $("#save_gp_td").hide();

    $("#create_poi_ktsd_xt").hide();
    $("#delete_poi_ktsd_xt").hide();
    $("#save_poi_ktsd_xt").hide();
    $("#create_gp_xt").hide();
    $("#delete_gp_xt").hide();
    $("#save_gp_xt").hide()
    $("#create_thvp_xt").hide();
...
var tailieudinhkem_host = "http://localhost/tiengiang_tnn/";
